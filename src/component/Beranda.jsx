...
const Beranda = () => {
  return (
    <div className="beranda pb-0 mx-auto">
      <div className="relative w-full h-screen overflow-hidden to-white">
        <img
          src={image1}
          alt="Hero Image"
      ...
      <div className="content2">
        <div className="container grid grid-cols-2 items-center bg-slate1 rounded-3xl mx-auto shadow-2xl">
      ...
      <div className="keunggulan">
        <div className="container grid grid-cols-2 mx-auto items-center">
          <div className="keunggulan-box">
            <img src={content1} alt="" className="rounded-2xl max-w-2xl"/>
          </div>
          <div className="keunggulan-box">
